...
<title>Holiday Drop Off - Contact Us</title>
...
<link href="SpryAssets/SpryTabbedPanels4.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
function valid(name,email,subject,msg)
{
	//alert("h");
...
<div class="middleleft">
  ...
  <div class="c1"></div>
              ...
              <div id="TabbedPanels4" class="TabbedPanels4">
                ...
                <div class="TabbedPanelsContentGroup">
                  <div class="TabbedPanelsContent1">
                    <form id="frmPage" name="frmPage" action="actions.php?action=contact_us_email_send" method="post">
	...
	font-family:"Century Gothic";">Please fill in the form to Contact Us</td>
                          ...
                          <tr>
                            <td colspan="4" align="right"><input type="image" name="image" src="images/cosendbt.png" id="submit" style="margin-right:8px;" value="Submit" onclick="return valid(name,email,subject,msg);" /></td>
                  ...
                  <div class="TabbedPanelsContent2">
                    ...
                    <div class="workforus-right-content-middile" style="height:842px; overflow:auto;">
                      <div class="workforus-image" style="margin:0px; padding:0px; margin-top:20px;">
                        <img width="622" height="317" src="images/uploads/035452121113.jpg"/>                      </div>
                      <p>
	&nbsp;</p>
<div>
