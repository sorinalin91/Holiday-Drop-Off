  ...
  <div class="c1"></div>
          ...
          <div class="bookonline-right-content">
            <div class="bookonline-heading-text"><img src="images/book-online-img.png" alt="" />
              <p>You are signed in as nielsbuckland1</p>
              <spn>
              <a href="#"><img src="images/signoutbt.png" alt="" /></a></span></div>
            <form method="post" action="paypal.php">
              <div class="bookonline-middle-content">
                <div id="TabbedPanels2" class="TabbedPane2s">
                  <ul class="TabbedPanelsTabGroup">
                    <li class="TabbedPanelsTab" tabindex="0">Summer Camp</li>
                  </ul>
                  <div class="TabbedPanelsContentGroup">
                    <div class="TabbedPanelsContent1">
                        ...
                        <tr>
                          <td colspan="2">&nbsp;</td>
                                                ...
                                                <tr>
                          <td align="left"></td>
                          <td height="30"  align="right" valign="top">Extended days are shown in <span>RED</span></td>
                        </tr>
                        						<tr>
                          <td colspan="2">
						  	<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="font-size:16px;  border-top: #999999 dotted 1px;padding:10px 0 15px 0;">Finn Ashworth </td>
                              </tr>
							</table>
						</td>
                      </tr>
													<tr>
                            	<td colspan="2" style="padding-bottom:10px;">januari camp 27 Jan 2014 &nbsp; - Mon                                                                 </td>
                          	</tr>
															 <tr>
                          <td colspan="2">
							<input type="hidden" name="product_name[]" value="Finn Ashworth" />
                          ...
                          <td colspan="2"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="font-size:16px;  border-top: #999999 dotted 1px;padding:10px 0 15px 0;">Finn Ashworth </td>
                                                            ...
                                                            <tr>
                                <td>januari camp 27 Jan 2014 &nbsp; - Mon                                                                 </td>
                              </tr>
                                                          </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="2"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="105"><a href="book-online.php"><img src="images/backbt.png" alt="" /></a></td>
                                <td width="523"><a href="#" onclick="return getPrint();"><img src="images/printpage.png" alt="" /></a></td>
                              </tr>
                    ...
                    <div class="TabbedPanelsContent1">Content 2</div>
                  </div>
                </div>
                <div class="c1"></div>
              </div>
              <div class="bottomblock">
                                <div class="total">Total Charge: &pound;10.00</div>
                <div style="clear:both;"></div>
                <div class="total">Discount: &pound;0.00</div>
                <div style="clear:both;"></div>
                <div class="total">Total Amount: &pound;10.00</div>
                <div class="c1"></div>
                <div class="oncart1">
                  <input type="hidden" name="discount_amount" value="0.00" />
                  <input type="submit" name="submit" value="Pay Now" style="background: none repeat scroll 0% 0% transparent; border: 0px none; color: rgb(0, 0, 0); cursor: pointer; font-weight: bold; height: 39px; font-size: 16px;" />
                </div>
              </div>
            </form>
            <div class="c1"></div>
